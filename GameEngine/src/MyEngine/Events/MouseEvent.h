...
namespace MyEngine {
	...
	public:
		...
		// Overriding to include information of mouse position
	...
	public:
		...
		// Overriding to include information of mouse scroll offset
		std::string ToString() const override {
			std::stringstream ss;
	...
	public:
		...
		// Overriding to include information of which mouse button is pressed
		std::string ToString() const override {
			std::stringstream ss;
	...
	public:
		...
		// Overriding to include information of which mouse button is released
		std::string ToString() const override {
			std::stringstream ss;
